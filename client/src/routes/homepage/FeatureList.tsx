...
import type { ProfileLoaderData } from "../../types/type";
...
const RecommendedList = () => {
  ...
  const viewMedia = (propertyId: number, type: "photos" | "videos") => {
    ...
    if (property) {
      console.log(
        `Viewing ${property[type]} ${type} for property ${propertyId}`
      );
    }
  };
    ...
    <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
          Discover our handpicked selection of premium properties that offer the
          perfect blend of luxury, comfort, and style.
        </p>
      </div>

      <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {savedPosts.map((property, index) => (
          <div
            key={property.id}
